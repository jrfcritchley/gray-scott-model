...
#aConc = np.random.rand(height, width).astype(np.double)

##for i in range(initBConc): #This is the number of time an initial amount of chemical B is p
...
#making the exponentiaion on bchem be a multiply by 2 does cool stuff
    ...
    cv2.imwrite(f'C:/Users/Jack Critchley/Desktop/GrayScott/saved_img_{reps}.png', aConc_scaled)
